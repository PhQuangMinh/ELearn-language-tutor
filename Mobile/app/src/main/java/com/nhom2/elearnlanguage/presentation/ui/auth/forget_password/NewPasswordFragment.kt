    ...
    private fun evaluatePassword(password: String): StrengthResult {
        ...
        if (p.length < 8) {
            return StrengthResult(
                ...
                messageColorRes = R.color.error_100,
                strokeColorRes = R.color.error_100,
            )
        }
        ...
        if (!hasLetter || !hasDigit) {
            return StrengthResult(
                ...
                messageColorRes = R.color.error_80,
                strokeColorRes = R.color.error_80,
            )
        }
        ...
        if (!hasSpecial) {
            return StrengthResult(
                ...
                messageColorRes = R.color.warning_100,
                strokeColorRes = R.color.warning_100,
            )
        }
        ...
        if (p.length >= 12) {
            return StrengthResult(
                ...
                messageColorRes = R.color.success_100,
                strokeColorRes = R.color.success_100,
            )
        }
