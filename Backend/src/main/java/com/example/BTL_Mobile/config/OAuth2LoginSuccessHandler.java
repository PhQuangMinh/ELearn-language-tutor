...
public class OAuth2LoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (registrationId == null) {
            getRedirectStrategy().sendRedirect(request, response, mobileRedirectUrl + "?error=unknown_provider");
            return;
        }
        ...
        AuthResponse authResponse = oAuth2Service.findOrCreateAndIssueTokens(providerId, email, name, registrationId);
        ...
        String redirectUrl = UriComponentsBuilder.fromUriString(baseRedirectUrl)
                ...
                .queryParam("username", authResponse.getUsername() != null ? authResponse.getUsername() : "")
                .queryParam("email", authResponse.getEmail() != null ? authResponse.getEmail() : "")
                .queryParam("fullName", authResponse.getFullName() != null ? authResponse.getFullName() : "")
